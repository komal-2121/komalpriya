...
public class actitime {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//driver.findElement(By.xpath("//td[@class='nameCell first']/input")).sendKeys("manualtesting");
		driver.findElement(By.xpath("//td[@class='nameCell first']/input")).sendKeys("A");
		
		driver.findElement(By.xpath("//td[@class='billingTypeCell']/div[2]")).click();
		
		driver.findElement(By.cssSelector(".dropdownContainer.components_typeOfWorkMenu.typeOfWorkEditorMenu.addNewTasks>div>div>div>div>div:nth-child(11)")).click();
		
		driver.findElement(By.cssSelector(".x-btn-text")).click();
		
		driver.findElement(By.cssSelector("#ext-gen110")).click();
		driver.findElement(By.cssSelector(".x-date-inner>tbody>tr:nth-child(3)>td>a>em>span")).click();
	...
	List<WebElement> atest = driver.findElements(By.cssSelector(".createdTasksRowsTable>tbody>tr>td>div>div"));
		...
		for(int i=0;i<atest.size();i++) {
			...
			if(atestoption.equals("testingATest")) {
				atestname.click();
			}
		}
		...
		delete2.click();
			...
			List<WebElement> atestdeleted = driver.findElements(By.cssSelector(".taskRowsTableContainer>table>tbody>tr>td>div>div"));
